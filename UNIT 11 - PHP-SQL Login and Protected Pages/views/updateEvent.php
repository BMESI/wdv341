...
if ($_SESSION['validuser'] !== "yes") {
	header('Location: ../../UNIT 11 - PHP-SQL Login and Protected Pages/views/logout.php'); 
}// end if session not valid
else{
$Login=  "login.php";
require "../../UNIT 11 - PHP-SQL Login and Protected Pages/controllers/FormValidation.php";
require("../../UNIT 11 - PHP-SQL Login and Protected Pages/controllers/Update.php");
require $Login;
$EM_event_name= "";
...
if(isset($_GET['event_id']) && $_GET['event_id'] !== ''){
	...
	// input values
	$_SESSION['UpdateID'] = $_GET['event_id'];
...
if( isset($_POST['updatebutton']) ){
	...
	if($validateupdate->ValidateInputLength($event_hour,2,1) == 'false' || $validateupdate->ValidateInputLength($event_minute,2,1) == 'false'   )  {
		...
		if( $FormValid == true ){
			...
			$Update->UpdateSingleEvent($_SESSION['UpdateID'],$event_name,$event_description,$event_presenter,$event_date,$event_time);
...
<form name="updateform" method="post" action="updateEvent.php">
